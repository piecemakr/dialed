...
export const features: Feature[] = [
  ...
  },
  {
    ...
    h2: 'Fully Safe and Zero Psychoactive Effects',
    description: 'Experience the benefits of DIALED with no psychoactive effects, ensuring a safe and worry-free supplement experience.',
  },
  {
    icon: '/icons/up.svg',
